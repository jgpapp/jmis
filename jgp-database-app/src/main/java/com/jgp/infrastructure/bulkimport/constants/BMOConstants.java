...
public final class BMOConstants {
    ...
    public static final int BUSINESS_LOCATION_COL = 6;// G
    ...
    public static final int BUSINESS_REGISTRATION_NUMBER_COL = 10;// K
    ...
    public static final int YOUTH_REGULAR_EMPLOYEES_COL = 14;// O
    public static final int TOTAL_CASUAL_EMPLOYEES_COL = 15;// P
    public static final int YOUTH_CASUAL_EMPLOYEES_COL = 16;// Q
    public static final int SAMPLE_RECORDS_KEPT_COL = 17;// R
    public static final int TA_NEEDS_COL = 18;// S
    public static final int OTHER_TA_NEEDS_COL = 19;// T
