...
public final class LoanConstants {
    ...
    public static final int DATE_APPLIED = 9;// J
    public static final int DATE_DISBURSED = 10;// K
    public static final int LOAN_AMOUNT_KES = 11;// L
    public static final int LOAN_DURATION = 12;// M
    public static final int OUT_STANDING_AMOUNT = 13;// N
    public static final int REPAID_LOAN_AMOUNT = 14;// O
    public static final int LOAN_QUALITY = 15;// P
    public static final int TOTAL_REGULAR_EMPLOYEES_COL = 16;// Q
